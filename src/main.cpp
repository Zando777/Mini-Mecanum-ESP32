...
// ------------------------------
// Controls 4 DC motors with AS5600 analog encoders.
...
// AS5600 encoders provide analog voltage output (0-3.3V) for position feedback
// Analog voltage represents rotational position: 0V=0°, 3.3V=360°
